...
class CardController {
  ...
  async createCard(req, res) {
    try {
      ...
      // Verifica se nome, raridade, pontos de ataque, pontos de defesa e o id da carta foram fornecidos
      if (
        !name ||
        !rarity ||
        !attackPoints ||
        ...
        return res
          .status(400)
          .json({ error: "Os campos nome, raridade, pontos de ataque, pontos de defesa e o id da carta são obrigatórios" });
      }
